...
> ⚠️ **Importante:** el proyecto necesita servirse desde HTTP/HTTPS. No funciona abriendo `index.html` como archivo local (`file://`) porque el navegador bloquea las llamadas a la API de Gemini. Usa una de las opciones de abajo.
...
```
https://tu-usuario.github.io/npcforge/
```
